...
5.  **Accès Maire (Super-Admin)** : Pour débloquer les pleins pouvoirs en local (construction, gestion du budget, prison), générez votre compte Maire avec la commande : `python manage.py createsuperuser`
